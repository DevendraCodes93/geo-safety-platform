...
const Hero = () => {
  ...
  return (
    <section
      className="relative md:pt-20 md:pb-16 py-12 overflow-hidden z-1"
      id="main-banner"
    >
      <div className="container mx-auto lg:max-w-screen-xl px-4">
        <div className="grid grid-cols-12">
          <motion.div {...leftAnimation} className="lg:col-span-5 col-span-12">
            <div className="flex gap-6 items-center lg:justify-start justify-center mb-5 mt-8">
              <Image
            ...
            <p className="text-gray-300 text-18 lg:text-start text-center mb-8 max-w-lg">
            ...
            <div className="flex items-center md:justify-start justify-center gap-8 mt-8">
      ...
      {/* Modals for Create URL and Track Location */}
      {isCreateURL && (
