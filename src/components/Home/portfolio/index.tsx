        ...
        <div className="grid lg:grid-cols-2 items-center gap-20">
          ...
          >
            <p className="sm:text-28 text-18 text-muted mb-4">
              Location Tracking <span className="text-primary">Features</span>
            </p>
            <h2 className="text-white sm:text-40 text-30 mb-4 font-medium">
              Advanced tracking capabilities with Location
              <span className="text-primary">Tracker Pro</span>!
            </h2>
            <p className="text-muted text-opacity-60 text-18">
              Our platform offers comprehensive location tracking features
              <br className="md:block hidden" /> for businesses and individuals.
            </p>
