  ...
  return (
    ...
    >
      <div className="lg:py-0 py-2">
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-4 min-h-[60px]">
          ...
          <div className="flex items-center gap-4">
            {/* Theme Toggle - Commented for simplicity */}
            {/* <button
            ...
            {/* Sign In Modal - Commented for simplicity */}
            {/* {isSignInOpen && (
            ...
            {/* Sign Up Modal - Commented for simplicity */}
            {/* {isSignUpOpen && (
              <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div
                  ref={signUpRef}
            ...
            <button
              ...
              className="block lg:hidden p-2 rounded-lg fixed right-4"
        ...
        >
          ...
          <nav className="flex flex-col items-start p-4">
            ...
            {/* Mobile Sign In/Up Buttons - Commented for simplicity */}
